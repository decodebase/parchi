...
import {
  Music, UtensilsCrossed, Trophy, Palette, Laugh, Handshake,
  BriefcaseBusiness, PartyPopper, Moon, Baby, CalendarDays, Cpu,
  type LucideIcon,
} from "lucide-react";
...
export function CategoryBadge({ category }: { category: EventCategory | string | null }) {
  ...
  const Icon = iconMap[category] ?? CalendarDays;
  return (
