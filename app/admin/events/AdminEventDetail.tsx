        ...
        <div className="p-5 space-y-6">
          ...
          {e.promo_video_url && (
            <div className="w-full aspect-video rounded-xl overflow-hidden bg-[#1A1A1E]">
              {e.promo_video_url.includes("youtube.com") || e.promo_video_url.includes("youtu.be") ? (
                <iframe
                  src={`https://www.youtube.com/embed/${extractYouTubeId(e.promo_video_url)}?autoplay=0&controls=1`}
